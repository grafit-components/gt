...
export class ItskDatePickerHelper {
  static getFirstDay(month: number, year: number, firstDayOfWeek: number): Date {
    ...
    const lastDayIndex = lastDay.getDay() >= firstDayOfWeek ? lastDay.getDay() - firstDayOfWeek : lastDay.getDay() + 7 - firstDayOfWeek;
  ...
  static isDateInvalid(
    ...
    return (
      ItskDatePickerHelper.isDayDisabled(dat, disabledDays) ||
