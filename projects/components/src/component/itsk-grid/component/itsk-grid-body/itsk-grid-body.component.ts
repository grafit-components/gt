...
@Component({
    ...
    imports: [NgIf, CdkVirtualScrollViewport, CdkFixedSizeVirtualScroll, CdkVirtualForOf, NgTemplateOutlet, NgFor, NgClass, ItskGridCellComponent, ItskCheckboxComponent, FormsModule, ItskGridExpandComponent, GroupRowWrapperComponent, ItskGridAdditionalComponent]
})
